...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"></link>
        ...
        <article id="main">
          <header className="special container">
            ...
            <h2>Our Team</h2>
            <p>Our team research focuses on <b>Software Engineering</b>, <b>Deep Learning</b> and  <b>Human-Computer Interaction</b>.</p>
          </header>
          {/* One */}
          <section className="wrapper style1 container special">
            <div className="row">
              ...
              <div className="col-4 col-12-narrower">
                <section>
                  <img src="https://chunyang-chen.github.io/picture/chunyangChen_headshot.jpg" alt="" style={{width: '70%', height: '70%'}} />
                  <header><br />
                    <h3>Chunyang Chen</h3>
                  </header>
              ...
              <div className="col-4 col-12-narrower">
                <section>
                  <img src="https://conf.researchr.org/getProfileImage/yujinhuang/e80f376a-72fd-40c7-8b03-d0420294d1ed/small.jpg?1610378790000" alt="" style={{width: '70%', height: '22rem'}} />
                  <header><br />
                    <h3>Yujin Huang</h3>
                  </header>
                  <p > Sed tristique purus vitae volutpat ultrices. Aliquam eu elit eget arcu commodo suscipit dolor nec nibh. Proin a ullamcorper elit, et sagittis turpis. Integer ut fermentum.</p>

                  <button style={{"border":"none","outline":"0","display":"inline-block","padding":"8px","color":"white","backgroundColor":"#000","textAlign":"center","cursor":"pointer","width":"50%","fontSize":"0.9rem"}}>Contact</button>
                </section>
              </div>
              <div className="col-4 col-12-narrower">
                <section>
                  <img src="https://www.jason-siu.com/About_me_files/Screenshot-2021-05-15-at-8.png" alt="" style={{width: '70%'}} />
                  <header><br />
